        ...
        <AnimatedSection delay={0.2} className="space-y-6 lg:col-span-2">
          <div className="rounded-2xl border border-border bg-white p-6 shadow-sm">
            ...
            <div className="mt-4 space-y-4">
              ...
              <div className="flex gap-3"><MapPin className="mt-0.5 h-5 w-5 shrink-0 text-primary" /><div><p className="text-sm font-medium text-text">Address</p><p className="text-sm text-text-light">TRUE CENTRIC LTD<br />20 Wenlock Road, London, England, N1 7GU</p></div></div>
          ...
          <div className="overflow-hidden rounded-2xl border border-border bg-surface">
            <div className="flex h-48 items-center justify-center">
              <div className="text-center"><MapPin className="mx-auto h-8 w-8 text-text-light/40" /><p className="mt-2 text-sm text-text-light">Wenlock Road, London, England</p></div>
            </div>
          </div>
        </AnimatedSection>
      </div>
