        ...
        <AnimatedSection delay={0.2} className="space-y-6 lg:col-span-2">
          <div className="rounded-2xl border border-border bg-white p-6 shadow-sm">
            ...
            <div className="mt-4 space-y-4">
              <div className="flex gap-3"><Mail className="mt-0.5 h-5 w-5 shrink-0 text-primary" /><div><p className="text-sm font-medium text-text">Email</p><p className="text-sm text-text-light">support@esim-ex.com</p></div></div>
              <div className="flex gap-3"><Phone className="mt-0.5 h-5 w-5 shrink-0 text-primary" /><div><p className="text-sm font-medium text-text">Phone</p><p className="text-sm text-text-light">+44 7447 196114</p></div></div>
              <div className="flex gap-3"><MapPin className="mt-0.5 h-5 w-5 shrink-0 text-primary" /><div><p className="text-sm font-medium text-text">Address</p><p className="text-sm text-text-light">ESIMEX LTD<br />Dept 6750, 196 High Road, Wood Green, London, United Kingdom, N22 8HH</p></div></div>
